"""HyperCube Heartbeat council supervisor for GARVIS capability governance."""
...
class CouncilAdvisoryReport:
    """Advisory report returned by a council consultation."""
...
class FullAgentHeartbeatSupervisor:
    """Fail-soft council supervisor backed by the HyperCube Heartbeat cycle."""
