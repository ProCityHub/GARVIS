"""Council heartbeat supervisor for GARVIS capability runtime."""
...
class CouncilAdvisoryReport:
    """Advisory report returned by the heartbeat supervisor after a consultation."""
...
class FullAgentHeartbeatSupervisor:
    """Lightweight council supervisor that checks repository health before protected actions."""
