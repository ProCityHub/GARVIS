...
各 エージェント で、タスクを前進させる方法を選択するために選べる、送信側のハンドオフオプションの一覧を定義できます。
...
エージェント の実行中に何が起きたかを確認するには、[OpenAI ダッシュボードの Trace ビューア](https://platform.openai.com/traces)に移動して、実行のトレースを表示します。
